<template>
  <div>
            ...
            <div class="w-full xl:w-1/2 xl:pr-8">
              ...
              >
                <div class="flex flex-col pr-8">
                  ...
                  <h3 class="pl-12 mt-3 text-base font-medium leading-5 text-gray-800 truncate">
                    Sandra Walton <span class="mt-1 text-sm leading-5 text-gray-500 truncate">- CEO SomeCompany</span>
                  </h3>
              ...
              >
                <div class="flex flex-col pr-10">
                  ...
                  <h3 class="pl-12 mt-3 text-base font-medium leading-5 text-gray-800 truncate">
                    Kenny Jones <span class="mt-1 text-sm leading-5 text-gray-500 truncate">- CEO SomeCompany</span>
                  </h3>
                  <p class="mt-1 text-sm leading-5 text-gray-500 truncate"></p>
                </div>
                <img
            ...
            <div class="w-full xl:w-1/2 xl:pl-8">
              ...
              >
                <div class="flex flex-col pr-10">
                  ...
                  <h3 class="pl-12 mt-3 text-base font-medium leading-5 text-gray-800 truncate">
                    Molly Sanchez <span class="mt-1 text-sm leading-5 text-gray-500 truncate">- CEO SomeCompany</span>
                  </h3>
                  <p class="mt-1 text-sm leading-5 text-gray-500 truncate"></p>
                </div>
                <img
    ...
    <footer class="px-4 pt-12 pb-8 text-white bg-white border-t border-gray-200">
      <div class="container flex flex-col justify-between max-w-6xl px-4 mx-auto overflow-hidden lg:flex-row">
        ...
        <div class="block w-full pl-10 mt-6 text-sm lg:w-3/4 sm:flex lg:mt-0">
          ...
          <ul class="flex flex-col w-full p-0 font-medium text-left text-gray-700 list-none">
            ...
            <li>
              <a href="https://devdojo.com/tails" class="inline-block px-3 py-2 text-gray-500 no-underline hover:text-gray-600">Tails</a>
            </li>
          </ul>
      ...
      <div class="pt-4 pt-6 mt-10 text-center text-gray-400 border-t border-gray-100">© 2020 Landmark. All rights reserved.</div>
    </footer>
  </div>
</template>
